...
def _task1_config() -> Any:
    module = importlib.import_module("llm_pysc2.agents.configs.llm_pysc2")
    config = module.ConfigPysc2_Harass()
    config.reset_llm(
    ...
    for team in config.AGENTS["CombatGroup7"]["team"]:
        team["task"] = [
            ...
            {"time": None, "pos": None, "info": "Destroy as many enemy workers as possible."},
        ]
    return config
